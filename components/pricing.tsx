...
const plans: Array<Plan> = [
  {
    id: planType.basic,
    name: "Introduction",
    shortDescription: "Free Trial Course",
    badge: "",
    price: 0,
    period: "one-time",
    features: [
      { text: "Basic flight simulator access (2 hours)", included: true },
      { text: "Introduction to aviation fundamentals", included: true },
      { text: "Basic instrument training", included: false },
      { text: "Emergency procedure training", included: false },
      { text: "Certificate upon completion", included: false },
    ],
    buttonText: "Start Free Trial",
    subText: "Try our simulator and see if aviation training is for you!",
    onClick: () => {
  ...
  },
  {
    ...
    shortDescription: "Complete Training Program",
    badge: "PILOTS' CHOICE",
    price: 2499,
    originalPrice: 3999,
    period: "one-time",
    features: [
      { text: "Full flight simulator access (unlimited)", included: true },
      { text: "Complete aviation curriculum", included: true },
      { text: "Advanced instrument training", included: true },
      { text: "Emergency procedure training", included: true },
      { text: "Professional pilot certification", included: true },
    ],
    buttonText: "Enroll Now",
    subText: (
      <div className="flex gap-1 justify-center items-center">
        <IconGift />
        38% off for the next 50 students (23 left)
      </div>
    ),
    onClick: () => {
  ...
  },
  {
    ...
    shortDescription: "6-Month Intensive Program",
    price: 1299,
    originalPrice: 1999,
    period: "one-time",
    features: [
      { text: "Advanced flight simulator access", included: true },
      { text: "Commercial pilot preparation", included: true },
      { text: "Advanced instrument training", included: true },
      { text: "Emergency procedure training", included: true },
      { text: "Commercial pilot certification prep", included: true },
    ],
    buttonText: "Start Training",
    subText: "Accelerated program for experienced aviators",
    onClick: () => {
      console.log("Get Advanced");
    },
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Start your aviation journey with our comprehensive training programs designed for pilots at every skill level, from beginners to advanced professionals.
        </p>
