      ...
      >
        <div className="relative z-20">
          ...
          <p className="max-w-lg text-xs sm:text-sm md:text-base text-neutral-400 text-center mx-auto my-4 md:my-6 lg:my-8 px-4">
            Take the first step towards becoming a pilot with Talent Trek Ascend. Our expert instructors and advanced simulators will guide you through every aspect of aviation training.
          </p>
        </div>
