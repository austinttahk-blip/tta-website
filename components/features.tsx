  ...
  return (
    ...
    >
      <div className="text-balance relative z-20 mx-auto mb-4 max-w-4xl text-center text-lg font-semibold tracking-tight text-neutral-300 md:text-3xl">
        ...
        >
          Simulator Features & Course Benefits
        </h2>
      </div>
      <p className="max-w-lg text-sm text-center mx-auto mt-4 text-neutral-400">
        Experience realistic aviation training with our state-of-the-art flight simulators and comprehensive courses designed for pilots.
      </p>
      <div className="mt-20  grid cols-1 lg:grid-cols-5 gap-4 auto-rows-[25rem] max-w-3xl mx-auto lg:max-w-none">
        <Card className="flex flex-col relative justify-between lg:col-span-2">
          ...
          <CardContent className="h-40 absolute bottom-0">
            ...
            <CardDescription>
              Experience authentic flight conditions with our advanced simulators.
            </CardDescription>
          </CardContent>
        </Card>
        <Card className="flex relative flex-col justify-between lg:col-span-3">
          <CardContent className="h-40">
            ...
            <CardDescription>
              Train according to international aviation standards with our certified courses that meet ICAO and FAA requirements worldwide.
            </CardDescription>
          </CardContent>
        ...
        <Card className="flex flex-col relative justify-between lg:col-span-3">
          ...
          <CardContent className="h-40 relative mb-4">
            ...
            <CardDescription>
              Join thousands of successful pilots who have completed their training with our comprehensive simulator programs and achieved their aviation goals.
            </CardDescription>
          </CardContent>
        ...
        <Card className="flex flex-col justify-between lg:col-span-2">
          <CardContent className="h-40">
            ...
            <CardDescription>
              Learn from certified aviation professionals with decades of experience in flight training and simulator instruction.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
...
const CARDS = [
  {
    ...
    content: (
      <p>
        The simulator training at Talent Trek Ascend was <Highlight>incredible</Highlight>. It prepared me perfectly for my first commercial flights. Highly recommended!
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        As an instructor, I can confidently say that their <Highlight>aviation courses</Highlight> are among the best. The attention to detail in emergency procedures is outstanding.
      </p>
    ),
  },
  {
    id: 2,
    name: "Dr. Emily Chen",
    designation: "Aviation Safety Expert",
    content: (
      <p>
        The <Highlight>realistic scenarios</Highlight> in their simulators help pilots develop critical decision-making skills that save lives in real emergencies.
      </p>
    ),
  },
];
