    ...
    >
      <div className="text-balance relative z-20 mx-auto mb-4 mt-4 max-w-4xl text-center text-4xl font-semibold tracking-tight text-neutral-300 md:text-7xl">
        <Balancer>
          ...
          >
            Master Aviation with Talent Trek Ascend
          </motion.h2>
        </Balancer>
      </div>
      <motion.p
      ...
      >
        Experience the future of aviation training with our advanced flight simulators and comprehensive courses designed for aspiring pilots.
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
